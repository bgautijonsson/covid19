...
```{r}
d %>% 
  filter(name == "cases", age == "total", type == "cumulative", aldursdreifing == "óhagstæð") %>% 
  ggplot(aes(date, median)) +
  geom_line(aes(lty = "Líklegasta spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  geom_point(data = iceland_d, aes(x = date, y = total_cases), inherit.aes = F) +
...
```{r}
d %>% 
  filter(name == "cases", age == "total", type == "active", aldursdreifing == "óhagstæð") %>% 
  ggplot(aes(date, median)) +
  geom_line(aes(lty = "Líklegasta spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  # geom_point(data = iceland_d, aes(x = date, y = total_cases), inherit.aes = F) +
...
```{r, fig.asp = 0.621}
d %>% 
  filter(name == "hospital", age == "total", type == "cumulative", aldursdreifing == "óhagstæð")  %>% 
  ggplot(aes(date, median)) +
  geom_line(aes(lty = "Líklegasta spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  scale_y_continuous(breaks = pretty_breaks(8)) +
...
```{r, fig.asp = 0.621}
d %>% 
  filter(name == "hospital", age == "total", type == "active", aldursdreifing == "óhagstæð")  %>% 
  ggplot(aes(date, median)) +
  geom_line(aes(lty = "Líklegasta spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  scale_y_continuous(breaks = pretty_breaks(8)) +
...
```{r, fig.asp = 0.621}
d %>% 
  filter(name == "icu", age == "total", type == "cumulative", aldursdreifing == "óhagstæð") %>% 
  ggplot(aes(date, median)) +
  geom_line(aes(lty = "Líklegasta spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  scale_y_continuous(breaks = pretty_breaks(8)) +
...
```{r, fig.asp = 0.621}
d %>% 
  filter(name == "icu", age == "total", type == "active", aldursdreifing == "óhagstæð") %>% 
  ggplot(aes(date, median)) +
  geom_line(aes(lty = "Líklegasta spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  scale_y_continuous(breaks = pretty_breaks(8)) +
