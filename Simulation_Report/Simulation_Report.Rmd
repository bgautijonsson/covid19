...
iceland_d <- sheets_read("https://docs.google.com/spreadsheets/d/1xgDhtejTtcyy6EN5dbDp5W3TeJhKFRRgm6Xk0s0YFeA", sheet = "Smit") %>% 
  rename(date = Dagsetning, total_cases = Smit_Samtals, active_cases = Virk_Smit) %>% 
  mutate(new_cases = LSH_Smit + IE_Smit,
         date = as_date(date)) %>% 
  select(date, total_cases, active_cases)
...
spitali <- sheets_read("https://docs.google.com/spreadsheets/d/1xgDhtejTtcyy6EN5dbDp5W3TeJhKFRRgm6Xk0s0YFeA", sheet = "Spitali") %>% 
  set_names(c("date", "spitali", "icu", "utskr_spitali_samtals", "spitali_samtals", "icu_samtals")) %>% 
...
**Helstu niðurstöður spálíkansins með gögnum til og með 3. apríl eru eftirfarandi:**
...
d %>% 
  ...
  geom_line(aes(lty = "Líkleg spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá"), col = "grey50") +
  geom_point(data = spitali, aes(x = date, y = icu_samtals)) +
  scale_y_continuous(breaks = pretty_breaks(8)) +
  scale_x_date(date_breaks = "1 weeks", date_labels = "%d/%m") +
  labs(linetype = " ") +
  theme(axis.title = element_blank(),
...
d %>% 
  ...
  geom_point(data = spitali, aes(x = date, y = spitali_samtals), inherit.aes = F) +
  scale_y_continuous(breaks = pretty_breaks(8)) +
  scale_x_date(date_breaks = "1 weeks", date_labels = "%d/%m") +
...
d %>% 
  ...
  geom_line(aes(lty = "Líkleg spá")) +
  geom_line(aes(y = upper, lty = "Svartsýn spá")) +
  geom_point(data = spitali, aes(x = date, y = icu), inherit.aes = F) +
  scale_y_continuous(breaks = pretty_breaks(8)) +
  scale_x_date(date_breaks = "1 weeks", date_labels = "%d/%m") +
  scale_colour_brewer(type = "qua", palette = "Set1") +
  labs(linetype = " ", col = " ") +
