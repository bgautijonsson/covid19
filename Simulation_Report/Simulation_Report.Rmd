...
iceland_d <- sheets_read("https://docs.google.com/spreadsheets/d/1xgDhtejTtcyy6EN5dbDp5W3TeJhKFRRgm6Xk0s0YFeA", sheet = "Smit") %>% 
  rename(date = Dagsetning, total_cases = Smit_Samtals, active_cases = Virk) %>% 
  mutate(new_cases = Ny_Smit + IE_Smit,
         date = as_date(date)) %>% 
...
Spáin um heildarfjölda greindra smita hefur hækkað frá því 30. mars, og spár um álag á heilbrigðiskerfið þá sömuleiðis. Til að búa undir möguleikann á frekari hliðrun aldursdreifingar fylgir önnur forspá þar sem gert er ráð fyrir að aldursdreifingin verði óhagstæðari.

**Helstu niðurstöður spálíkansins með gögnum til og með 1. apríl eru eftirfarandi:**

* Gert er ráð fyrir því að á meðan faraldurinn gengur yfir muni rúmlega `r smit_cumul$median` manns á Íslandi vera greind með COVID-19, en talan gæti náð nær `r smit_cumul$upper` manns skv. svartsýnni spá.
