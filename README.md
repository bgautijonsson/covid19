Hér eru skrár og kóði á bak við vefsíðuna [bgautijonsson.shinyapps.io/COVID_Dashboard](bgautijonsson.shinyapps.io/COVID_Dashboard) og annar kóði sem ég hef verið að fikta við.
