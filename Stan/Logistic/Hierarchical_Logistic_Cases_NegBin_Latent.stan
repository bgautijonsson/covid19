...
model {
  ...
  country_kappa_detected ~ exponential(0.001);
  ...
  //  Likelihood
  total_deaths ~ poisson(death_rate * f[total_days]);
  new_cases ~ neg_binomial_2(dfdt .* perc_detected .* pop[country], phi[country]);
}
