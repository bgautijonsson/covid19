...
while (TRUE) {
    ...
    write_rds(m, str_c("Stan/Logistic/Past_Models_GenLogistic/Model_", cur_date, ".rds"))
    write_csv(d, str_c("Stan/Logistic/Past_Models_GenLogistic/Stan_Data_", cur_date, ".csv"))
